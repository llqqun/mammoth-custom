...
function DocumentConverter(options) {
    return {
        convertToHtml: function(element) {
            ...
            console.log('第一步', comments);
            var conversion = new DocumentConversion(options, comments);
            let result = conversion.convertToHtml(element);
            console.log('结果Promise', result);
            return result
        }
    };
}
...
function DocumentConversion(options, comments) {
    console.log('NEW 一个 DocumentConversion', options);
    var noteNumber = 1;
    ...
    function convertToHtml(document) {
        var messages = [];
        console.log('convertToHtml46:', document);
        ...
        return promises.mapSeries(deferredNodes, function(deferred) {
            ...
            // console.log('html字符串', writer.asString());
            debugger;
